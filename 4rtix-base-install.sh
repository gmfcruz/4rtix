...
artix-chroot /mnt ln -sf /etc/runit/runsvdir/default /etc/runit/sv/dmeventd 
artix-chroot /mnt ln -sf /etc/runit/runsvdir/default /etc/runit/sv/dbus
artix-chroot /mnt ln -sf /etc/runit/runsvdir/default /etc/runit/sv/cronie
