...
cryptsetup -v --cipher aes-xts-plain64 --key-size 256 --hash sha256 --iter-time 2000 --use-urandom --verify-passphrase luksFormat /dev/vda3
...
basestrap /mnt base base-devel runit elogind-runit linux-lts mkinitcpio grub efibootmgr
...
cryptsetup luksAddKey /dev/vda3 /mnt/crypto_keyfile.bin
chmod 000 /mnt/crypto_keyfile.bin

artix-chroot /mnt mkinitcpio -p linux-lts
